...
def iridescence():
	...
	return render_template('album.html',album=album,artist=artist,genre=genre ,date=date,cover=cover,review=review,rating=rating,length=length,label=label,spotify=spotify)
...
def alive():
	...
	return render_template('album.html',album=album,genre=genre, artist=artist,date=date,cover=cover,review=review,rating=rating,length=length,label=label,spotify=spotify)
...
def orange():
	...
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,length=length,label=label,spotify=spotify)
