...
def date():
	ImageNo='50%'
	artistA="The Strokes"
	artistAurl="http://set09103.napier.ac.uk:9159/genre/indie_rock/the_strokes/"
...
def iridescence():
	...
	label='RCA'
	genre='Hip Hop'
	spotify='https://open.spotify.com/embed/album/3Mj4A4nNJzIdxOyS4yzOhj'
	return render_template('album.html',album=album,artist=artist,genre=genre ,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def alive():
	...
	spotify='https://open.spotify.com/embed/album/3Bz2QPL8NLBn1d03jXtNkT'
	return render_template('album.html',album=album,genre=genre, artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def orange():
	...
	spotify='https://open.spotify.com/embed/album/623Ef2ZEB3Njklix4PC0Rs'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def in_colour():
	...
	spotify='https://open.spotify.com/embed/album/0AVPusXNzK1jWwefBiPJ5I'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def KSG():
	...
	spotify='https://open.spotify.com/embed/album/6pwuKxMUkNg673KETsXPUV'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def is_this_it():
	...
	spotify='https://open.spotify.com/embed/album/3EeZu1PTUY341mnNEiyiYl'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def xx():
	...
	spotify='https://open.spotify.com/embed/album/2nXJkqkS1tIKIyhBcFMmwz'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
...
def awaken_my_love():
	...
	spotify='https://open.spotify.com/embed/album/4xnq1L6P551Qcb9gBXNMK7'
	return render_template('album.html',genre=genre,album=album,artist=artist,date=date,cover=cover,review=review,rating=rating,tracks=tracks,length=length,label=label,spotify=spotify)
